...
const WelcomeHeader = () => {
  ...
  return (
    <LinearGradient
        colors={theme.dark ? ["#3c43485c", "#3c43485c", "#3c43485c"]: ["#75ABFC", "#0047AB"]}
...
const styles = StyleSheet.create({
    headerWrapper: {
        /* This code snippet is setting the height of the `headerWrapper` style based on certain
        conditions. */
        height: IsHaveNotch 
        ?  IsIPAD 
            ? verticalScale(175) 
    ...
    input: {
        ...
        fontSize: IsIPAD ? fontSizes.FONT15 : fontSizes.FONT15,
